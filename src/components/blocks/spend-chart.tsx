 ...
 * keeps the accent off anything showing a quantity. What makes it defensible
 * rather than sloppy: there is no figure anywhere on this chart, so the
 * accent is not competing with a credit figure, which is what the rule exists
 * to prevent. Check that again if a figure is ever added back.
 *
 * It uses --lime-ink, not --lime. The accent as shipped cannot carry a line
 * on paper at all: lime measures 1.02:1 against the paper ground, and the
 * other four are no better. --lime-ink is the same hue darkened until it
 * clears 4.5:1, defined per accent in globals.css.
 *
    ...
    >
      <defs>
        <linearGradient id="spend-fill" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="var(--lime-ink)" stopOpacity="0.22" />
          <stop offset="100%" stopColor="var(--lime-ink)" stopOpacity="0" />
        </linearGradient>
      </defs>
